...
.. description: r is not the best tool for data engineering
-->
...
this post is partially a rant on technical debt. i do think r succeeds at its intended purpose: an analysis language for those with stats background, but little to no previous knowledge of programming. it is not meant for production etl.

the legacy r scripts were created a while ago and don't really follow any software engineering best-practices.
some r scripts have over fifteen hundred lines of code, featuring:
...
## a side note on the r package manager
